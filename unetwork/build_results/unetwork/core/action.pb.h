...
#ifndef GOOGLE_PROTOBUF_INCLUDED_unetwork_2fcore_2faction_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_unetwork_2fcore_2faction_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_unetwork_2fcore_2faction_2eproto
...
struct TableStruct_unetwork_2fcore_2faction_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_unetwork_2fcore_2faction_2eproto;
namespace unetwork {
class Action;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::unetwork::Action* Arena::CreateMaybeMessage<::unetwork::Action>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace unetwork {
...
class Action :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:unetwork.Action) */ {
 public:
  Action();
  virtual ~Action();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_unetwork_2fcore_2faction_2eproto);
    return ::descriptor_table_unetwork_2fcore_2faction_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_unetwork_2fcore_2faction_2eproto;
};
// ===================================================================
...
inline ::unetwork::OptimizationParameter* Action::mutable_optimization_params(int index) {
  // @@protoc_insertion_point(field_mutable:unetwork.Action.optimization_params)
...
Action::mutable_optimization_params() {
  // @@protoc_insertion_point(field_mutable_list:unetwork.Action.optimization_params)
  return &optimization_params_;
}
inline const ::unetwork::OptimizationParameter& Action::optimization_params(int index) const {
  // @@protoc_insertion_point(field_get:unetwork.Action.optimization_params)
  return optimization_params_.Get(index);
}
inline ::unetwork::OptimizationParameter* Action::add_optimization_params() {
  // @@protoc_insertion_point(field_add:unetwork.Action.optimization_params)
...
Action::optimization_params() const {
  // @@protoc_insertion_point(field_list:unetwork.Action.optimization_params)
  return optimization_params_;
}
...
inline const std::string& Action::info() const {
  // @@protoc_insertion_point(field_get:unetwork.Action.info)
...
inline void Action::set_info(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:unetwork.Action.info)
}
inline void Action::set_info(std::string&& value) {
  
  info_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:unetwork.Action.info)
}
inline void Action::set_info(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:unetwork.Action.info)
}
inline void Action::set_info(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:unetwork.Action.info)
}
inline std::string* Action::mutable_info() {
  
  // @@protoc_insertion_point(field_mutable:unetwork.Action.info)
...
inline std::string* Action::release_info() {
  // @@protoc_insertion_point(field_release:unetwork.Action.info)
...
inline void Action::set_allocated_info(std::string* info) {
  ...
  // @@protoc_insertion_point(field_set_allocated:unetwork.Action.info)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_unetwork_2fcore_2faction_2eproto
