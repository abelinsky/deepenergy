...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n%energyplatform/core/observation.proto\x12\x0e\x65nergyplatform\x1a\x1f\x65nergyplatform/core/types.proto\";\n\x0bObservation\x12,\n\x05items\x18\x01 \x03(\x0b\x32\x1d.energyplatform.PhysicalParamb\x06proto3')
  ,
...
_OBSERVATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='items', full_name='energyplatform.Observation.items', index=0,
...
_OBSERVATION.fields_by_name['items'].message_type = energyplatform_dot_core_dot_types__pb2._PHYSICALPARAM
